...
import { LocationsManagement } from "../Store"
function ContactsList() {
   ...
   const onSubmit = async (text) => {
      ...
      var newzone = await LocationsManagement.CreateZones({location:text,code:locationcode})
      console.log(newzone)
      getlistContact()
      setlocationcode('')
      setSearchText('')
   ...
   const DeleteZones = async (text) => {
      ...
      var listzone = await LocationsManagement.deleteZone(text)
      getlistContact()
      console.log(listzone)
            ...
            renderItem={({ item }) => (
               <View style={styles.itemContainer}>
                  <View style={styles.textContainer}>
                     <Text style={styles.nameText}>{item.location}</Text>
                     <Text style={styles.phoneText}>{item.code}</Text>
                  </View>
